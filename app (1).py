...
class QGen:
    ...
    def __init__(self):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained('t5-large',model_max_length=2024)
        ...
        self.s2v = Sense2Vec().from_disk(r'C:\Users\Mohammed Nasser\s2v_old')
...
@app.route('/')
def home():
    return render_template('Tayaqqun.html')

UPLOAD_FOLDER = r'C:\Users\vvip3\OneDrive\Desktop\Tayaqqun'
...
def upload_file():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            global txt
            txt=""
            f='C:/Users/vvip3/OneDrive/Desktop/Tayaqqun/'+filename
            ...
            if txt!="":
               print("i am here")
               qg = QGen()
               payload = { "input_text": "Sachin Ramesh Tendulkar is a former international cricketer from India and a former captain of the Indian national team. He is widely regarded as one of the greatest batsmen in the history of cricket. He is the highest run scorer of all time in International cricket."}
               output = qg.predict_shortq(payload)
               print(output)
               dic=output
               cards = [
    {'front1': dic['questions'][0]['Question'], 'back1': dic['questions'][0]['Answer'] ,
      'front2': dic['questions'][1]['Question'], 'back2': dic['questions'][1]['Answer'],
      'front3': dic['questions'][2]['Question'], 'back3': dic['questions'][2]['Answer']}
]

               return render_template('res.html', cards=cards )
